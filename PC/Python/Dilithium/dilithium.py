import os
from Dilithium.modules.modules import ModuleDilithium


try:
    from xoflib import shake256
except ImportError:
    from Dilithium.shake.shake_wrapper import shake256
...
class Dilithium:
    ...
    def set_drbg_seed(self, seed):
        ...
        """
        try:
            from Dilithium.drbg.aes256_ctr_drbg import AES256_CTR_DRBG
